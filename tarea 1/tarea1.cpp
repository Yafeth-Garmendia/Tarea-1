...
void ajusteDeInvetnarioPositivo() {
    string codigo = "";
    int cantidad = 0;

    system("cls");
    cout << endl;
    cout << "ajuste posivito de Productos al Inventario" << endl;
    cout << "******************************************" << endl;
    cout << "Ingrese el codigo del producto: ";
    cin >> codigo;
    cout << endl;
...
void ajusteDeInvetnarioNegativo() {
    string codigo = "";
    int cantidad = 0;
...
int main(int argc, char const *argv[])
{
    ...
    while(true) {
        ...
        case 3:
            ...
            break;
        case 4:  
            ajusteDeInvetnarioPositivo();
            break;
        case 5:  
            ajusteDeInvetnarioNegativo();
            break;
